<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="ASP_Net_MicroProject.Login" %>
             ...
             <div class="card">
                ...
                <div class="card-body">
                    ...
                    <asp:Button 
                        ...
                        runat="server" 
                        Text="Login" 
                        CssClass="btn btn-primary logreg_btn" 
                    ...
                    <asp:Button
                        ...
                        runat="server"
                        Text="Register"
                        CssClass="btn btn-secondary logreg_btn"
                    ...
                    <asp:Label 
                        ID="lblMessage" 
                        runat="server" 
                        CssClass="text-danger mt-2 incorrect_label" ></asp:Label>

                    <a href="ForgotPassword.aspx" class="forgot_label">Forgot Password</a>
                </div>
            </div>
        </div>
        <!-- Login Cart End -->
